...
public class VoiceRecognition {
    ...
    private native void initVR(Context context);
    private native void startVR(int sampleRate, int tokenCount);
    private native void putData(byte data[], int count);
