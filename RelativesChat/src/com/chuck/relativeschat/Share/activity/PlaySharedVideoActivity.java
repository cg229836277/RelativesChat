...
public class PlaySharedVideoActivity extends BaseActivity{
	
	public static final String VIDEO_URL = "video_url";
	public static final String VIDEO_CACHE_URL = "video_cache_url";
	...
	private void playVideo() {
        ...
        if (localUrl == null) {
            ...
            localUrl = BmobConstants.RECORD_VIDEO_CACHE_PATH + fileName;
            System.out.println("localUrl: " + localUrl);
            File file = new File(localUrl);
    	    if(file != null && file.exists()){
                mVideoView.setVideoPath(file.getAbsolutePath());
                mVideoView.start();
                System.out.println("在本地缓存中存在该文件");
                return;
    	    }
        }
